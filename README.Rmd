...
- Finally, we also looked at two special cases: Duke-owned apartment 300 Swift, and the few outliers that were located on Campus Drive. 
...
First we look into how many duke students actively registered to vote during 
...
duke_students %>%
  ...
  labs(
    x = "Year",
    y = "Number of Duke students who registered",
    title = "Number of Duke students who actively registered to vote"
  ) +
  theme_minimal()
```
...
duke_students %>%
  ...
  labs(
    x = "Year",
    y = "Number of Duke students who registered",
    title = "Number of Duke students who were registered to vote"
  ) +
  theme_minimal()
```
...
Interestingly, while the number of Duke students who were registered to vote in 
Durham, NC increased each election year, it seems the number of those who were 
actively registering or voting decreased.
...
We also looked some into our secondary question of how Duke student's poltical 
...
It seems that the number of Duke students registered as Democrat increased over 
